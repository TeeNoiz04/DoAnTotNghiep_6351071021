...
public class PriceOfferPPDetailExcelDtoConverter : ExcelDtoConverter<PriceOfferDetailImportDto, PriceOfferDetailCreateParams>
{
    public PriceOfferPPDetailExcelDtoConverter(
