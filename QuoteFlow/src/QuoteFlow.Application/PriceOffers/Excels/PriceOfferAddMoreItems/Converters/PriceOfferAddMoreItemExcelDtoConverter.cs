...
namespace QuoteFlow.PriceOffers.Excels.PriceOfferAddMoreItems.Converters;
public class PriceOfferAddMoreItemExcelDtoConverter : ExcelDtoConverter<PriceOfferDetailImportDto, PriceOfferDetailCreateParams>
{
    public PriceOfferAddMoreItemExcelDtoConverter(
