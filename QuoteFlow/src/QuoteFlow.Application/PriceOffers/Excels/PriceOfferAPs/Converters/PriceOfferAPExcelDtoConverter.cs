...
public class PriceOfferAPExcelDtoConverter : ExcelDtoConverter<PriceOfferImportDto, PriceOfferCreateParams>
{
    private readonly PriceOfferManager _priceOfferManager;
    private readonly IExcelImportFactory _excelImportFactory;

    public PriceOfferAPExcelDtoConverter(
    ...
    {
        var priceOfferCode = await _priceOfferManager.GenerateNewCodeAsync(PriceOfferConsts.KeyAccountPrefix, importDto.MaterialType!);
