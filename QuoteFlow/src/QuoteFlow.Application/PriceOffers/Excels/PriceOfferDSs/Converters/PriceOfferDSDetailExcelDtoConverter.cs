...
public class PriceOfferDSDetailExcelDtoConverter : ExcelDtoConverter<PriceOfferDetailImportDto, PriceOfferDetailCreateParams>
{
    public PriceOfferDSDetailExcelDtoConverter(
