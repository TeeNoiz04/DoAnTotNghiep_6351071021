...
public class StockTracingReceiptValidator : BaseExcelValidator<StockTracingReceiptImportDto>
{
    ...
    public StockTracingReceiptValidator(ExcelValidationConfig config, IExcelRowValidator<StockTracingReceiptImportDto> rowValidator, ILogger<BaseExcelValidator<StockTracingReceiptImportDto>> logger, IServiceProvider provider) : base(config, rowValidator, logger)
    {
    ...
    protected override async Task PostValidateAsync(ExcelValidationResult<StockTracingReceiptImportDto> result, ExcelImportContext? context = null)
    {
