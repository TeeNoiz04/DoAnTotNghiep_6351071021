...
/// <inheritdoc />
public partial class Added_MaterialStockLockShipment : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            name: "MaterialStock_LockShipment",
            columns: table => new
            {
                Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                GolfaCode = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                LockOnOrder = table.Column<int>(type: "int", nullable: true),
                StockOnOrder = table.Column<int>(type: "int", nullable: true),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_MaterialStock_LockShipment", x => x.Id);
            });
    }
