...
/// <inheritdoc />
public partial class Added_WorkflowConfiguration : Migration
{
    /// <inheritdoc />
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.CreateTable(
            ...
            columns: table => new
            {
                ...
                WF_Type = table.Column<string>(type: "nvarchar(50)", maxLength: 50, nullable: false),
                WF_Level = table.Column<short>(type: "smallint", nullable: false),
                WF_Role = table.Column<string>(type: "nvarchar(4000)", maxLength: 4000, nullable: false),
            ...
            constraints: table =>
            {
                table.PrimaryKey("PK_Workflow_Configuration", x => x.Id);
            });
    }
