...
public class MaterialApprovalRequestDetailUpdateDto : IHasConcurrencyStamp
{
    [Required]
    ...
    [StringLength(MaterialApprovalRequestDetailConsts.ActionMaxLength)]
    public virtual string? Action { get; set; }
    [StringLength(MaterialApprovalRequestDetailConsts.FactoryRefDocMaxLength)]
