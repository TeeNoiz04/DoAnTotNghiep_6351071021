...
public class Material : ExtendedAuditedAggregateRoot<Guid>
{
    [NotNull]
    ...
    //public virtual DateTime? IndeactiveDate { get; set; }
    ...
    //public virtual Guid? Factory { get; set; }

    //public virtual Guid? Vendor { get; set; }

    //public virtual int? LeadTime { get; set; }

    //public virtual decimal? RefExchangeRate { get; set; }
    ...
    public ICollection<MaterialStock>? MaterialStock { get; set; }
    ...
    public Material(Guid id, MaterialCreateParams createParams)
    {
        Id = id;
