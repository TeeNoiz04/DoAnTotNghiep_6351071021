...
@Component({
  selector: 'app-sale-report-general-dialog',
  standalone: true,
...
export class SaleReportGeneralDialogComponent implements OnInit, OnChanges {
  ...
  private reportService = inject(SaleReportGeneralDialogService);
      ...
      this.onGenerateReport(formValue).subscribe({
        next: result => {
          ...
          if (result instanceof Blob) {
            ...
            const fileName = `R05-SaleReport-${dd}${mm}${yy}.xlsx`;
