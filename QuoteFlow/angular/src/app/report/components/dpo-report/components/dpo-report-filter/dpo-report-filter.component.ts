...
@Component({
  selector: 'app-dpo-report-filter',
  templateUrl: './dpo-report-filter.component.html',
  standalone: true,
  styleUrls: ['./dpo-report-filter.component.scss'],
  imports: [
    FormsModule,
    NgbModule,
    NgSelectModule,
...
export class DPOReportFilterComponent implements OnInit {
