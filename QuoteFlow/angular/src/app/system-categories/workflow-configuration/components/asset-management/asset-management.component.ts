...
import {
  AbstractAssetManagementComponent,
  ChildTabDependencies,
  ChildComponentDependencies,
} from './asset-management.abstract.component';
...
export class AssetManagementComponent extends AbstractAssetManagementComponent {}
